...
/**
 * Creates a two-lane Myers kernel bound to caller-owned PEQ tables.
 *
 * @param {Uint32Array} peq0 - Low 32-bit lane equality table.
 * @param {Uint32Array} peq1 - High 32-bit lane equality table.
 * @returns {(a1: string, b1: string) => number}
 */
export function createMyersX64(peq0, peq1) {
 ...
 * b = target/reference
 */
  return function myers_x64_bound(a1, b1) {
